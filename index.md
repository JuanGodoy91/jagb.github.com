...
<div class='pag'>
	...
	<div data-sr='wait 0.7s, enter right, hustle 100px' class='col-lg-12 col-md-12 col-sm-12 col-xs-8 hg-60 border-left border-bottom'>
		<!-- label 1 "this" -->
		<div class='fila'>
			<a href=''><h2 class='label'>review</h2></a>
		</div>
	</div>
</div> <!-- end of pag -->
			  	...
			  	<div class="slide__content">
			    	...
			    	<div class='pag'>
				    	<div class='text-frame'>
					        <div class="slide__text">
								<!-- heading title letter -->
					          	<h1 class="slide__text-heading">N</h1>
					        </div>
				    	</div>
				        <div class="slide__text description">
				        	<!-- heading description -->
		      	...
		      	<div class="slide__content">
		        	...
		        	<div class='pag'>
		        		<div class='text-frame'>
				        	<div class="slide__text">
				        		<!-- heading title letter -->
				          		<h1 class="slide__text-heading">W</h1>
				        	</div>
			    		</div>
			        	<div class="slide__text description">
			        		<!-- heading description -->
		      	...
		      	<div class="slide__content">
		        	...
		        	<div class='pag'>
		        		<div class='text-frame'>
				        	<div class="slide__text">
				        		<!-- heading title letter -->
				          		<h1 class="slide__text-heading">S</h1>
				        	</div>
			    		</div>
			        	<div class="slide__text description">
			        		<!-- heading description -->
